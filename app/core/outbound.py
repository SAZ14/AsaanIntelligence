...
def notify_staff(store_id: int, message: str) -> int:
    ...
    (a VIP just joined the queue, a review needs attention). Returns how
    many numbers it reached; best-effort, a failed send to one staff
    member doesn't block the others."""
