...
Deliberately simple and transparent (per the v1 decision): a weighted sum of
booking + guest-history features, clamped to a probability and bucketed into a
band with a recommended door action. No model training, no LLM — fully testable
and explainable to venue staff.
"""
